...
<html >
	...
	<div class="form-horizontal content-center">
	            <input type="hidden" class="form-control" id="id" name="id" value="${n.id }">
				...
				<div class="form-group">
				<label for="catagory" class="col-sm-4 control-label">商品类别</label>
				<div class="col-sm-8">
				<input type="text" class="form-control" id="catagory_sn" name="catagory_sn">
				</div>				
				</div>
<div class="col-sm-8 col-sm-offset-4"><button type="submit" class="btn btn-primary">修改商品</button></div>
		</div>
