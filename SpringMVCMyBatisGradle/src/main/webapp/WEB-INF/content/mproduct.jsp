								...
								<!-- PAGE CONTENT BEGINS -->
										...
										<div class="table-responsive">
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                <c:forEach items="${requestScope.good_list }" var="g">
													<tr>
														...
														<td>
															...
															<img src="images/photos/${g.image }" height="70">
														...
														<td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="blue" href="addproduct">

																	<i class="icon-zoom-in bigger-130"></i>

																</a>

																<a class="green" href="listproduct.action?id=${g.id }">

																	<i class="icon-pencil bigger-130"></i>

																</a>
			                                                 <a class="red" href="deleteproduct.action?id=${g.id }">
