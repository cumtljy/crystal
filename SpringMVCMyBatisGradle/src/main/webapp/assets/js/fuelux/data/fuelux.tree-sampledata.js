...
var tree_data = {
	'Present' : {name: 'Present', type: 'folder'}	,
...
tree_data['Present']['additionalParameters'] = {
	'children' : {
		'flowers' : {name: 'flowers', type: 'item'},
		'books' : {name: 'books', type: 'item'},
		'watches' : {name: 'watches', type: 'item'},

	}
}
tree_data['Clothing']['additionalParameters'] = {
	'children' : {
...
tree_data['Clothing']['additionalParameters']['children']['cars']['additionalParameters'] = {
	'children' : {
