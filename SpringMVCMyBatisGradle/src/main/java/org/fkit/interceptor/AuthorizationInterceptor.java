...
public class AuthorizationInterceptor  implements HandlerInterceptor {
	...
	private static final String[] IGNORE_URI = {"/find", "/login","/register","/updateSuccess",
			"/backPassword","/registerSuccess","/adminLogin","/main","/addproduct","/mproduct","/listproduct","/updateproduct","/deleteproduct","/success",
			 "/treeview","/lookorder","/updateorder","/newstock","/updatestock"};
